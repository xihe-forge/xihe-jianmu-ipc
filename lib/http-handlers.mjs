  ...
  return function handleRequest(req, res) {
    ...
    // ---- POST /wake-suspended ----
      ...
      req.on('end', () => {
        ...
        const subscribers = broadcastToTopic('network-up', message);
        ...
        audit('http_wake_suspended', { reason, from, broadcastTo: subscribers.length, subscribers });
        stderr(`[ipc-hub] HTTP POST /wake-suspended: broadcasted to ${subscribers.length} network-up subscriber(s)`);
      });
