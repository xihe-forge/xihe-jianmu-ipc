...
test(
  'ipc_spawn: host=wt dryRun returns wt command_hint with inner cwd switch',
  ...
  async () => {
    ...
    try {
      ...
      const escapedWindowsCwd = escapeRegex(sandbox.replace(/\//g, '\\'));
