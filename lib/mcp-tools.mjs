...
export const MCP_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description:
      'Return ccusage cost summary for today, 7d, 30d, or all, optionally grouped by IPC/project name or model.',
    inputSchema: {
      type: 'object',
      properties: {
        window: {
...
export function createMcpTools(ctx) {
  ...
  async function handleToolCall(name, args) {
    ...
    if (name === 'ipc_cost_summary') {
      ...
      try {
        return toJsonResult(await getCostSummary({ window, group_by: groupBy }));
      } catch (err) {
